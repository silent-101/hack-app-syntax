...
const imgs = [
	"https://images.unsplash.com/photo-1454496522488-7a8e488e8606?q=80&w=1176&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
	"https://images.unsplash.com/photo-1624807136278-e2973be118ff?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
	"https://images.unsplash.com/photo-1624700316277-ca0170f8cc59?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
	"https://images.unsplash.com/photo-1532375810709-75b1da00537c?q=80&w=1176&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
function Home() {
	...
	useGSAP(
		() => {
			...
			const lodingPercent =
				loaderTxtRef.current?.querySelectorAll(".loading-percent span") || [];
	...
	return (
		<div
			className="w-full relative min-h-screen flex items-center justify-center bg-black overflow-hidden"
			ref={boxRef}
		>
			{imgs.map((item, index) => (
				<div
			...
			<h1
				ref={loaderTxtRef}
				className="text-[25vh] font-boska bg-transparent tracking-[-0.5rem] font-bold z-10 metrophobic-regular flex items-center justify-center absolute inset-0"
			>
				{loaderTxt.split("").map((letter) => (
					<p key={letter} className="overflow-hidden bg-transparent">
